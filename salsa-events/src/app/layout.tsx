...
// Sets the `dark` class before paint, based on the stored preference or (if
// none is stored yet) the device's system preference. Runs synchronously in
// <head> so there's no flash of the wrong theme on load.
